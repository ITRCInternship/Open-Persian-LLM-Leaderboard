...
# معرفی  
Qwen2 جدیدترین سری از مدل‌های زبانی بزرگ Qwen است. در این سری، مدل‌های پایه و مدل‌های آموزش‌دیده‌ی دستوری با اندازه‌های مختلف از ۰.۵ تا ۷۲ میلیارد پارامتر منتشر شده‌اند که شامل یک مدل ترکیبی از متخصصان (Mixture-of-Experts) نیز می‌شود. این مخزن شامل مدل ۷B Qwen2 آموزش‌دیده‌ی دستوری است.  
...
برای اطلاعات بیشتر، می‌توانید به وبلاگ، GitHub و مستندات ما مراجعه کنید.  

جزئیات مدل  
Qwen2 یک سری مدل زبانی شامل مدل‌های زبانی دیکدر با اندازه‌های مختلف است. برای هر اندازه، هم مدل پایه و هم مدل چت هماهنگ‌شده را منتشر کرده‌ایم. این مدل بر اساس معماری Transformer با فعال‌سازی SwiGLU، بایاس QKV توجه، توجه پرس‌وجوی گروهی و غیره ساخته شده است. علاوه بر این، یک توکن‌ایزر بهبودیافته داریم که با چندین زبان طبیعی و کدها سازگار است.
