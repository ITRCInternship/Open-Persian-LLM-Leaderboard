...
این مدل با **۷۰.۶B پارامتر** و دقت **bfloat16**، یکی از قوی‌ترین مدل‌های زبانی موجود است، با عملکرد قابل‌توجه در **پردازش زبان فارسی (۷۱.۴%)**. 
...
| **تعداد لایه‌ها** | **۶۴** |  
| **تعداد هدهای توجه (GQA)** | **۴۰ برای Q و ۸ برای KV** |  
| **طول زمینه (Context Length)** | **۳۲,۷۶۸ توکن (پشتیبانی کامل)** |  
