...
این مدل قدرتمند از **۲۳ زبان** پشتیبانی می‌کند و برای تحقیقات و کاربردهای چندزبانه طراحی شده است.  
...
- **اندازه مدل:** ۳۲ میلیارد پارامتر  

---

### **نسخه‌های موجود**  
این مدل‌کارد مربوط به نسخه **32 میلیارد پارامتری** است. یک نسخه **8 میلیارد پارامتری** نیز منتشر شده که می‌توانید [اینجا] پیدا کنید.  
